...
const RegisterForm = () => {
  ...
  const handleRegister = async (e) => {    // Objeto con los datos del registro
    const userData = {
      username,
      email,
      password,
              ...
              <div className="column is-half has-background-white">
                <div className="card">
                  ...
                  <div className="card-content">
                    <div className="is columns p-5">
                      <div className=" column">
                        <div className="p-2">
                          <input
                            className={`input ${errors.document ? "is-primary" : ""}`}
                            type="text"
                            name="document"
                            {...register("document", {
                        ...
                        <div className="p-2">
                          <input
                            className={`input ${errors.name ? "is-primary" : ""}`}
                            type="text"
                            {...register("name", {
                              required: "Este campo es obligatorio",
                            })}
                        ...
                        <div className="p-2">
                          <input
                            className={`input ${errors.email ? "is-primary" : ""}`}
                            type="text"
                            {...register("email", {
                              required: "Este campo es obligatorio",
                            })}
                        ...
                        <div className="p-2">
                          <input
                            className= {`input ${errors.phone ? "is-primary" : ""}`}
                            type="text"
                            {...register("phone", {
                              required: "Este campo es obligatorio",
                            })}
                      ...
                      <div className=" column">
                        <div className="p-2">
                          <input
                            className={`input ${errors.username ? "is-primary" : ""}`}
                            type="text"
                            {...register("username", {
                              required: "Este campo es obligatorio",
                            })}
                        ...
                        <div className="p-2">
                          <input
                            className={`input ${errors.lastname ? "is-primary" : ""}`}
                            type="text"
                            {...register("lastname", {
                              required: "Este campo es obligatorio",
                            })}
                        ...
                        <div className="p-2">
                          <input
                            className={`input ${errors.password ? "is-primary" : ""}`}
                            type="text"
                            {...register("password", {
                              required: "Este campo es obligatorio",
                            })}
                        ...
                        <div className="p-2">
                          <input
                            className={`input ${errors.address ? "is-primary" : "input"}`}
                            type="text"
                            {...register("address", {
                              required: "Este campo es obligatorio",
                            })}
